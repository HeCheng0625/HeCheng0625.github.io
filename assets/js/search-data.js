...
ninja.data = [{
    ...
    handler: () => {
      ...
      handler: () => {
          ...
          description: "",
          section: "News",},{id: "news-we-released-code-3k-stars-in-one-week-and-checkpoints-of-maskgct-which-has-been-used-in-quwan-all-voice",
          title: '🔥 We released code (3k+ stars in one week) and checkpoints of MaskGCT,...',
          description: "",
